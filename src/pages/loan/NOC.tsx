...
const LoanNOC = () => {
    ...
    const handleSave = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Update column T (20) for Collect NOC Status and conditionally R (18) for Actual 2
            await updateGoogleSheetCellsBySn('Loan', selectedLoan.sn, updates);

            // Update local state
            updateLoan(selectedLoan.id, {
                collectNocStatus: collectNoc as 'Yes' | 'No',
                ...(collectNoc === 'Yes' && { actual2: formattedDate })
            });
